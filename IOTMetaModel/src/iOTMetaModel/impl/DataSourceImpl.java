 ...
 * </p>
 * <ul>
 *   <li>{@link iOTMetaModel.impl.DataSourceImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DataSourceImpl extends EObjectImpl implements DataSource {
	...
	protected EClass eStaticClass() {
		return IOTMetaModelPackage.Literals.DATA_SOURCE;
	}
	...
	public void setId(Integer newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IOTMetaModelPackage.DATA_SOURCE__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IOTMetaModelPackage.DATA_SOURCE__ID:
				return getId();
		}
