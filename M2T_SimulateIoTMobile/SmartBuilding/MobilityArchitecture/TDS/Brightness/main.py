...
def TDN():
    ...
    ipMongo, port = readIP('brightness1')

    topicscoll = [{"name": "Brightness", "sipnosis": "Future, work", "tags": ["Future", "Work"],"date": datetime.datetime.utcnow()}
]                  
