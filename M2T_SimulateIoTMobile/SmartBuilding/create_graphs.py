    ...
    with open(archivo, "r") as file:
        for linea in file:
            if linea.startswith("DEVICE "):
                # Utilizar expresión regular para extraer el valor de "value" (entero o flotante)
...
for archivo in os.listdir(logs_path):
    if archivo.startswith("sensor-") and archivo.endswith(
        ".log"
    ):  # Solo archivos con extensión .log
