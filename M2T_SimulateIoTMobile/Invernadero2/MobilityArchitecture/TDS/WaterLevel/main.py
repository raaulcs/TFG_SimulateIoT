...
def TDN():
    ...
    ipMongo, port = readIP('waterlevel2')

    topicscoll = [{"name": "WaterLevel", "sipnosis": "Future, work", "tags": ["Future", "Work"],"date": datetime.datetime.utcnow()}
]                  
