...
if cryptography_found:
	...
	print ('\n----------------------------------------------------------------------------------------------------\n')
	print ("Starting to run Arduino-CLI ('load-config-arduino-SensA0.py')\n")
	print ('----------------------------------------------------------------------------------------------------\n')
	if os.path.exists(os.path.dirname(os.path.dirname(PATH))+'/arduino-cli/libraries'):
		...
		shutil.copy2(PATH+'/SensA0.ino', PATH+'/arduino/arduino.ino')
		...
		print ("End of Arduino-CLI run ('load-config-arduino-SensA0.py')")
	else:
		print("Arduino Command Line is not installed. Please, run the installer script ('install-arduino.py')")
else:
	print ("\nThe required libraries are not installed. Please, rerun the script again ('load-config-arduino-SensA0.py')")
print ('\n----------------------------------------------------------------------------------------------------\n')
