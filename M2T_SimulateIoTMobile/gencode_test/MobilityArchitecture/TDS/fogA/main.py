...
def TDN():
    ...
    ipMongo, port = readIP('foga0')

    topicscoll = [{"name": "A1", "sipnosis": "Future, work", "tags": ["Future", "Work"],"date": datetime.datetime.utcnow()}
,{"name": "A2", "sipnosis": "Future, work", "tags": ["Future", "Work"],"date": datetime.datetime.utcnow()}
,{"name": "X", "sipnosis": "Future, work", "tags": ["Future", "Work"],"date": datetime.datetime.utcnow()}
]                  
