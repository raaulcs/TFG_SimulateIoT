...
def TDN():
    ...
    ipMongo, port = readIP('fogb1')

    topicscoll = [{"name": "TopicB", "sipnosis": "Future, work", "tags": ["Future", "Work"],"date": datetime.datetime.utcnow()}
,{"name": "TopicC", "sipnosis": "Future, work", "tags": ["Future", "Work"],"date": datetime.datetime.utcnow()}
]                  
