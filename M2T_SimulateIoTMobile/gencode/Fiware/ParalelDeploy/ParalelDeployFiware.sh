...
bash "$parent_path"/gencode/Fiware/ParalelDeploy/ConfigureMachine_fogA0.sh "$TOKEN" &
bash "$parent_path"/gencode/Fiware/ParalelDeploy/ConfigureMachine_fogB1.sh "$TOKEN" &
